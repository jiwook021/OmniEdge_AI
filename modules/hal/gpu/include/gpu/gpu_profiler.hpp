...
public:
    ...
    [[nodiscard]] GpuTier tier() const noexcept { assert(hasProbed_); return selectedTier_; }
    [[nodiscard]] const VramInfo& vramInfo() const noexcept { assert(hasProbed_); return vramInfo_; }
