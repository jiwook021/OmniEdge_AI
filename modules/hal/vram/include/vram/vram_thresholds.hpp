...
inline constexpr std::size_t kTtsMiB        =  512;   ///< TTS ONNX (Kokoro 82M, Dynamic INT8) — arena fragments above floor; 512 MiB gives kNextPowerOfTwo extension headroom
...
inline constexpr std::size_t kSecurityVlmMiB    = 3000; ///< Gemma-4 E4B vision variant (HF transformers), lazy-load
...
inline constexpr std::size_t kSecurityVlmInferenceHeadroomMiB    = 400; ///< Gemma vision encoder activations + decoder KV cache
