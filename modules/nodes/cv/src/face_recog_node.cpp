...
tl::expected<void, std::string> FaceRecognitionNode::onConfigure()
{
	OE_ZONE_SCOPED;
	...
	for (int attempt = 1; attempt <= 10; ++attempt) {
		try {
			...
			OE_LOG_WARN("face_recog_shm_retry: attempt={}/10, waiting for {}: {}",
...
tl::expected<void, std::string> FaceRecognitionNode::onLoadInferencer()
{
	OE_ZONE_SCOPED;
