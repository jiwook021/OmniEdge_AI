...
// ---------------------------------------------------------------------------
// BlurInferencer — pure virtual interface for YOLOv8-seg + composite operations.
//
// Concrete implementations:
//   TensorRTBlurInferencer  — TensorRT engine + nvJPEG (production)
//   MockBlurInferencer      — returns a fixed-size JPEG stub (tests / CPU-only CI)
// ---------------------------------------------------------------------------
...
public:
    ...
    /** Load the TensorRT engine and allocate GPU buffers.
     ...
     *  2. Preprocess → YOLOv8-seg inference → mask upscale
