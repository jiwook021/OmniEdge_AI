...
enum class UiAction : uint8_t {
    ...
    kSwitchBootMode,
    kSnapshot,
    kGetConversationHistory,
    kClearConversationHistory,
    kUnknown,
};
...
inline constexpr std::array kUiActionMap = {
    ...
    std::pair{UiAction::kGetConversationHistory,   std::string_view{"get_conversation_history"}},
    std::pair{UiAction::kClearConversationHistory, std::string_view{"clear_conversation_history"}},
};
