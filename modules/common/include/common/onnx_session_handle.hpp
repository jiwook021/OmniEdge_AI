...
//   auto result = encoder.load(modelPath, /*useTRT=*/true);
...
struct SessionHandle {
	...
	// -----------------------------------------------------------------
	[[nodiscard]] tl::expected<void, std::string>
	loadCudaOnly(const std::string& modelPath)
	{
		return load(modelPath, /*useTRT=*/false);
	}
