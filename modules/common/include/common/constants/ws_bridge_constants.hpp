...
inline constexpr std::string_view kZmqTopicConversationHistory = "conversation_history";
// kZmqTopicModuleStatus lives in zmq/heartbeat_constants.hpp (lifecycle topic).
