...
// Previously duplicated try-catch in every main.cpp.
//
...
//
// Previously 3 identical lines in every main.cpp:
//   OeLogger::instance().setModule("omniedge_xxx");
//   OeLogger::instance().initFile(OeLogger::resolveLogDir());
//   OeLogger::instance().applyLogLevelFromIni("config/omniedge.ini", "xxx");
//
