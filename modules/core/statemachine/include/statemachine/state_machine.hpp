...
using State = std::variant<
    ...
    fsm::ImageTransform, fsm::SuperResolution, fsm::Sam2Segmentation>;

enum class StateIndex : std::size_t {
    kIdle = 0, kListening = 1, kProcessing = 2,
    kSpeaking = 3, kInterrupted = 4, kErrorRecovery = 5,
    kImageTransform = 6, kSuperResolution = 7, kSam2Segmentation = 8,
};

inline constexpr std::size_t kStateCount = 9;
inline constexpr std::size_t kEventCount = 21;
