 ...
 *
 * Supports both the 7B and 3B variants.  Both produce native audio output
 * (supportsNativeAudio() == true) -- no TTS sidecar required.
 *
...
public:
    ...
    [[nodiscard]] bool supportsNativeAudio() const noexcept override { return true; }
