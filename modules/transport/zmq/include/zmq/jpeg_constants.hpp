...
/// = sizeof(ShmVideoHeader) + sizeof(ShmCircularControl) = 64 + 64 = 128.
inline constexpr std::size_t kVideoShmFirstSlotOffset = 128;
...
/// Layout: [ShmAudioHeader padded to 64 B] [ShmCircularControl 64 B] [slots...]
inline constexpr std::size_t kAudioShmDataOffset = 128;
