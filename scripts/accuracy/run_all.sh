...
run_eval "llm"       "$SCRIPT_DIR/eval_llm_accuracy.py"     "LLM Accuracy (Qwen 2.5 7B -- QA + Arithmetic)"
...
run_eval "seg"       "$SCRIPT_DIR/eval_segmentation.py"     "Person Segmentation (YOLOv8-seg)"
